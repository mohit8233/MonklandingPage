...
function ServicePageCard({ service, index }) {
  ...
  return (
    <motion.div
      ...
      className="group relative flex h-full flex-col overflow-hidden rounded-[28px] border border-[#E5ECE8] bg-white p-6 shadow-md transition-all duration-500 hover:border-[#65C18C] hover:shadow-[0_20px_60px_rgba(101,193,140,0.18)] sm:p-7 lg:p-8"
    >
      {/* Glow */}
      ...
      <div className="mt-auto flex items-center justify-between gap-4 border-t border-[#EEF2EF] pt-6">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-[#3D3B3B] text-white transition-all duration-300 hover:bg-[#65C18C] sm:h-12 sm:w-12"
        >
